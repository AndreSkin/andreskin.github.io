$(document).ready(function(){
    ...
    $('#e_add').one('click',function(event){
        ...
        let fragments = ['o', 'e', 'r', 'm', 'n', '.', 'd', 'a', 'c', 'u', 't', ':', 'h', 'l', 's', 'p', 'b', 'i', symbol];
        let order = [3, 7, 17, 13, 10, 0, 11, 7, 4, 6, 2, 1, 7, 5, 14, 8, 12, 17, 4, 0, 15, 15, 17, 18, 14, 10, 9, 6, 17, 0, 5, 9, 4, 17, 16, 0, 5, 17, 10];
        var href = "";
