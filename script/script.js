$(document).ready(function(){
    ...
    $('#e_add').one('click',function(event){
        ...
        let fragments = ['o', symbol, '.', 'e', 'n', 's', 't', 'p', 'a', 'u', 'h', 'r', 'b', 'i', 'c', 'd'];
        let order = [8, 4, 15, 11, 3, 8, 2, 5, 14, 10, 13, 4, 0, 7, 7, 13, 1, 5, 6, 9, 15, 13, 0, 2, 9, 4, 13, 12, 0, 2, 13, 6];
        var href = "";
        ...
        $(".icons").append(`<br>My email is: <a href="${href}">${href}</a>`);
